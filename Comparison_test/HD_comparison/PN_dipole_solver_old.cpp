...
const double epsilon0 = 8.8541878188e-12; //constants.epsilon0;
const double n0 = 1.0;
const double mu0 = 1.25663706127e-6; //constants.mu0;
const double k0 = 2 * pi / 325e-9;// constants.k0;
...
* (1.0 + 1.0 / (j * k0 * r) - 1.0 / (k0 * k0 * r * r)) * expK0r;
}
...
complex<double> expK0r = exp( -j * k0 * r);
