...
plt.savefig("SimData/surface_plot_air.png", dpi=300)
print("✅ Plot saved to surface_plot_air.png")
...
# Save to file
plt.savefig("SimData/field_magnitude_slice_air.png", dpi=300)
print("✅ Field plot saved to field_magnitude_slice_air.png")
...
df.to_csv("SimData/field_sampled_air.csv", index=False)
print("✅ Saved sampled 3D field data to SimData/field_3d_sampled_air.csv")
...
with h5py.File("SimData/field_data_air.h5", "w") as f:
...
print("✅ Field data saved to SimData/field_data_air.h5")
...
fig.write_html("SimData/field_magnitude_surface_air.html")
print("✅ 3D surface plot saved to field_magnitude_surface_air.html")
