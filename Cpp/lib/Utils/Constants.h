...
struct Constants {
    ...
    static constexpr double epsilon0 = 1.0; //8.8541878188e-12; // Normalized permittivity of free space (in arbitrary units) // 8.8541878188e-12; // Permittivity of free space
    static constexpr double epsilon1 = 2.56; // *8.8541878188e-12;             // Substrate epsilon value????
    static constexpr double mu0      = 1.0;  //1.25663706127e-6; // Normalized permeability of free space (in arbitrary units) // 1.25663706127e-6; // Permeability of free space
